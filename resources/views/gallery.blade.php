        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="w-full md:w-2/3 lg:w-1/2 text-center lg:text-left">
                ...
                <p class="md:text-lg text-white/90">
                    Lihat berbagai proyek yang telah kami kerjakan, mulai dari pembangunan infrastruktur hingga pengembangan properti. Setiap proyek mencerminkan komitmen kami terhadap kualitas dan inovasi.
                </p>
            </div>
        </div>
    </div>
