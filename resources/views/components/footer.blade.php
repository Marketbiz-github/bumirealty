        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        <li><a href="#" class="text-teal-100 hover:text-white transition">Kavling Investasi</a></li>
                        <li><a href="#" class="text-teal-100 hover:text-white transition">Produk Layanan</a></li>
                        <li><a href="#" class="text-teal-100 hover:text-white transition">Testimoni Konsumen</a></li>
                        <li><a href="#" class="text-teal-100 hover:text-white transition">Portofolio Project</a></li>
                        <li><a href="#" class="text-teal-100 hover:text-white transition">Galeri Project</a></li>
                        <li><a href="#" class="text-teal-100 hover:text-white transition">Artikel</a></li>
                    </ul>
                </div>
