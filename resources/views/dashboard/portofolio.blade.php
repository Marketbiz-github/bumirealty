...
@section('content')
<div class="">
    <x-breadcrumb :items="[['label' => 'Portofolio']]" />
    ...
    <div class="mt-8">
        <div class="sm:flex sm:items-center">
            ...
            <div class="mt-4 sm:mt-0 sm:ml-16 sm:flex-none">
                <a href="{{ route('portofolio.create') }}" class="inline-flex items-center justify-center rounded-md border border-transparent bg-teal-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-teal-700 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:ring-offset-2 sm:w-auto">
                    Add Portofolio
                </a>
            </div>
        </div>
